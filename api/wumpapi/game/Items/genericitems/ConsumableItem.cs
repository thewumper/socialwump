...
public class ConsumableItem(string name, string id, string description, int price, string[] requirements, string[] conflicts, float cooldown, UsableItem.UseDelegate onUse, int maxUses) : UsableItem(name, id, description, price, conflicts, requirements, cooldown, onUse), IConsumableItem
{
