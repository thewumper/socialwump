...
public class GameManager : IGameManager
{
    ...
    public async Task Startup(INeo4jDataAccess dataAccess, IUserRepository userRepository, IItemRegistry itemRegistry)
    {
        ...
        var saveData = hasSaveData ? (await dataAccess.ExecuteReadDictionaryAsync(@"MATCH (n:Data) RETURN n {State: n.State, SavedAlliances:n.SavedAlliances} LIMIT 1","n")).FirstOrDefault()!.DictToObject<GameSaveData>() : new GameSaveData();
